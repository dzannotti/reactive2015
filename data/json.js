export default {
  ...
  sponsors: [
    { // gold - strv
      level: 10,
      company: '$ref(companies[22])'
    },
    { // silver - formidable labs
      level: 20,
      company: '$ref(companies[21])'
    },
    { // silver - liftago
      level: 20,
      company: '$ref(companies[23])'
    },
    { // bronze - smartbase
      level: 30,
      company: '$ref(companies[24])'
    },
    { // bronze - promiseo
      level: 30,
      company: '$ref(companies[25])'
    },
    { // bronze - futurice
      level: 30,
      company: '$ref(companies[1])'
    ...
    { // media - reactjsde
      level: 40,
      company: '$ref(companies[26])'
    },
    { // media - zdrojack
      level: 40,
      company: '$ref(companies[27])'
    },
    { // media - fevr
      level: 40,
      company: '$ref(companies[28])'
    },
    { // media - rising stack
      level: 40,
      company: '$ref(companies[29])'
    },
    { // media - robime
      level: 40,
      company: '$ref(companies[30])'
    },
    { // media - pc revue
      level: 40,
      company: '$ref(companies[31])'
    },
    { // media - computer world
      level: 40,
      company: '$ref(companies[32])'
    },
    { // media - firefox dev
      level: 40,
      company: '$ref(companies[33])'
    }
  ],
  events: [ // type 0=no type 1=blue 2=purple 3=green 4=yellow
    // workshops
    {
      day: 0,
      startsAt: 800,
    ...
    },
    {
      ...
      endsAt: 1615,
      type: 2,
      speaker: '$ref(speakers[3])',
      title: 'WHAT DO REACTIVE APPS REACT TO?',
    ...
    },
    {
      ...
      endsAt: 1715,
      type: 2,
      speaker: '$ref(speakers[7])',
      title: 'Dato - a functional way to build reactive applications',
      excerpt: 'Dato is a new way of building applications, heavily inspired by Meteor/Firebase/Relay, but informed by functional, data-oriented programming techniques.  The goal is to provide: Seamless, permission-aware data synching between the sever and n-clients Seamless, permission-aware rpc invocations A more flexible, intuitive UI layer Advanced tooling layer for time-traveling debuggers, state serialization, component layout, query editing, performance optimizations, and others. Integration on the backend to stream into analytics, session replay, 3rd-party integration'
    },
    {
      day: 2,
      startsAt: 1715,
      endsAt: 1800,
      speaker: '$ref(speakers[0])',
